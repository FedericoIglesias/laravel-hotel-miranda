...
<body>
    ...
    <div class="bar" id="bar">
        <div class="header__div header display--none" id="bar__menu">
            <div class="div__emblem">
                ...
                <h1 class="h1__name">Hotel <span>Miranda</span> </h1>
            </div>
            <div class="div__hamburguer" id="bar__menuBtn">
    ...
    <header>
        <div class="header ">
            ...
            <div class="div__hamburguer" id="menuBtn">
                <span class="line1"></span>
                <span class="line2"></span>
                <span class="line3"></span>
            </div>
    ...
    <footer>
        <div class="footer__div">
            <article class="art__logo">
                ...
                <div class="logo__social">
                    <div><a href=""><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div><a href=""><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_13_778)">
                                    <path d="M12.6477 10.6758V10.6392C12.6401 10.6515 12.632 10.6639 12.6239 10.6758H12.6477Z" fill="#777777" />
        ...
        <div class="footer__div2">
            <div class="copyright">
                <p>Copyright By Dev. Iglesias Federico - 2023</p>
